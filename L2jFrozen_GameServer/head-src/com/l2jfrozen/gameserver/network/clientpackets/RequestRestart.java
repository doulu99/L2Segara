...
public final class RequestRestart extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
        ...
        if(player.isInsideZoneFuction(L2Character.ZONE_MULTIFUNCTION) && !L2MultiFunctionZone.restart_zone)
        {
                player.sendMessage("You cannot restart while inside a Solo zone.");
                sendPacket(RestartResponse.valueOf(false));
                return;
        }
