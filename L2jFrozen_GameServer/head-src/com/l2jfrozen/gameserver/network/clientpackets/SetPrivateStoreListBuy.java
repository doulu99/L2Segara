...
public final class SetPrivateStoreListBuy extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (player.isInsideZoneFuction(L2Character.ZONE_MULTIFUNCTION) && !L2MultiFunctionZone.store_zone)
		{
		     player.sendPacket(new PrivateStoreManageListBuy(player));
		     player.sendMessage("You cannot start store while inside Solo zone.");
		     return;
		}
