...
public enum SystemMessageId
{
	/**
	 * ID: 1<br>
	 * Message: The server will be coming down in $1 Hours/minutes/seconds. Please find a safe place to LOGGER out.
	 */
	THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_HOURS(2038),
	THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_MINUTES(2039),
