...
public class NpcHtmlMessage extends L2GameServerPacket
{
	...
	protected final SimpleDateFormat fmt = new SimpleDateFormat("H");
...
protected static int _period;
	...
	public void replace(String pattern, String value)
	{
		...
		_html = _html.replaceAll("%OlympaidEnd%", "Olympiad period ends in " + numDays + " days," + numHours + " hours, " + numMins + " mins." );
	}
