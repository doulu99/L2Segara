...
public class Shutdown extends Thread
{
	public enum ShutdownModeType
	{
		...
		ShutdownModeType(final String modeText)
		{
			_modeText = modeText;
		}
	...
	public void startTelnetShutdown(final String IP, final int seconds, final boolean restart)
	{
		...
		if (_seconds == 30 || _seconds == 20 || _seconds == 10 || _seconds == 5 || _seconds == 4 || _seconds == 3 || _seconds == 2 || _seconds == 1)
		{
			_an.announceToAll("Server is " + MODE_TEXT[_shutdownMode] + " after " + _seconds + " second(s)!");
	...
	private void countdown()
	{
		...
		try
		{
			while (_secondsShut > 0)
			{
				...
				switch (_secondsShut)
				{
					// Hours shutdown start from here!!!
					case 18000:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 5 Hour(s).");
						SystemMessage sm = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_HOURS);
						sm.addString(Integer.toString(5));
						Announcements.getInstance().announceToAll(sm);
						sm = null;	
						break;
						
					case 14400:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 4 Hour(s).");
						SystemMessage sm1 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_HOURS);
						sm1.addString(Integer.toString(4));
						Announcements.getInstance().announceToAll(sm1);
						sm1 = null;	
						break;
						
					case 10800:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 3 Hour(s).");
						SystemMessage sm2 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_HOURS);
						sm2.addString(Integer.toString(3));
						Announcements.getInstance().announceToAll(sm2);
						sm2 = null;
						break;
						
					case 7200:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 2 Hour(s).");
						SystemMessage sm3 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_HOURS);
						sm3.addString(Integer.toString(2));
						Announcements.getInstance().announceToAll(sm3);
						sm3 = null;
						break;
						
					case 3600:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 1 Hour(s).");
						SystemMessage sm4 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_HOURS);
						sm4.addString(Integer.toString(1));
						Announcements.getInstance().announceToAll(sm4);
						sm4 = null;	
						break;
					
					// end Hours start minutes shutdown start from here!!!
						
					case 1800:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 30 Minutes(s).");
						SystemMessage sm5 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_MINUTES);
						sm5.addString(Integer.toString(30));
						Announcements.getInstance().announceToAll(sm5);
						sm5 = null;		
						break;
						
					case 1200:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 20 Minutes(s).");
						SystemMessage sm6 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_MINUTES);
						sm6.addString(Integer.toString(20));
						Announcements.getInstance().announceToAll(sm6);
						sm6 = null;	
						break;
						
					case 600:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 10 Minutes(s).");
						SystemMessage sm7 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_MINUTES);
						sm7.addString(Integer.toString(10));
						Announcements.getInstance().announceToAll(sm7);
						sm7 = null;	
						break;
						
					case 300:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 5 Minutes(s).");
						SystemMessage sm8 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_MINUTES);
						sm8.addString(Integer.toString(5));
						Announcements.getInstance().announceToAll(sm8);
						sm8 = null;	
						break;
						
					case 240:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 4 Minutes(s).");
						SystemMessage sm9 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_MINUTES);
						sm9.addString(Integer.toString(4));
						Announcements.getInstance().announceToAll(sm9);
						sm9 = null;	
						break;
						
					case 180:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 3 Minutes(s).");
						SystemMessage sm10 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_MINUTES);
						sm10.addString(Integer.toString(3));
						Announcements.getInstance().announceToAll(sm10);
						sm10 = null;	
						break;
						
					case 120:
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 2 Minutes(s).");
						SystemMessage sm11 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_MINUTES);
						sm11.addString(Integer.toString(2));
						Announcements.getInstance().announceToAll(sm11);
						sm11 = null;	
						break;
						
					case 60:
						LoginServerThread.getInstance().setServerStatus(ServerStatus.STATUS_DOWN); // avoids new players from logging in
						_an.announceToAll("The server is " + MODE_TEXT[_shutdownMode] + " after 1 minute(s).");
						SystemMessage sm12 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_MINUTES);
						sm12.addString(Integer.toString(1));
						Announcements.getInstance().announceToAll(sm12);
						sm12 = null;
						break;
					
						// end Hours,munutes start seconds shutdown start from here!!!
						
					case 30:
						_an.announceToAll("Server is " + MODE_TEXT[_shutdownMode] + " after 30 second(s)!");
						SystemMessage sm13 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_SECONDS);
						sm13.addString(Integer.toString(30));
						Announcements.getInstance().announceToAll(sm13);
						sm13 = null;
						break;
						
					case 5:
						_an.announceToAll("Server is " + MODE_TEXT[_shutdownMode] + " after 5 second(s)!");
						SystemMessage sm14 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_SECONDS);
						sm14.addString(Integer.toString(5));
						Announcements.getInstance().announceToAll(sm14);
						sm14 = null;
						break;
						
					case 4:
						_an.announceToAll("Server is " + MODE_TEXT[_shutdownMode] + " after 4 second(s)!");
						SystemMessage sm15 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_SECONDS);
						sm15.addString(Integer.toString(4));
						Announcements.getInstance().announceToAll(sm15);
						sm15 = null;
						break;
						
					case 3:
						_an.announceToAll("Server is " + MODE_TEXT[_shutdownMode] + " after 3 second(s)!");
						SystemMessage sm16 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_SECONDS);
						sm16.addString(Integer.toString(3));
						Announcements.getInstance().announceToAll(sm16);
						sm16 = null;
						break;
						
					case 2:
						_an.announceToAll("Server is " + MODE_TEXT[_shutdownMode] + " after 2 second(s)!");
						SystemMessage sm17 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_SECONDS);
						sm17.addString(Integer.toString(2));
						Announcements.getInstance().announceToAll(sm17);
						sm17 = null;
						break;
						
					case 1:
						_an.announceToAll("Server is " + MODE_TEXT[_shutdownMode] + " after 1 second(s)!");
						SystemMessage sm18 = new SystemMessage(SystemMessageId.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_SECONDS);
						sm18.addString(Integer.toString(1));
						Announcements.getInstance().announceToAll(sm18);
						sm18 = null;	
						break;
				}
