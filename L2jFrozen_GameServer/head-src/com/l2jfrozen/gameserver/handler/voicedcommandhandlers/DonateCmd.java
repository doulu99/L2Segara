...
public class DonateCmd implements IVoicedCommandHandler
{
 	  ...
 	  private void showHtmlWindow(L2PcInstance activeChar)
 	  {
 			...
 			NpcHtmlMessage html = new NpcHtmlMessage(1);
 				...
 				tb.append("<tr>");
 				tb.append("<td align=center><font color=\"6fd3d1\">Easy Donation With Gopay</font></td>");
 				tb.append("</tr>");
 				tb.append("</table>");
 				...
 				tb.append("<td><combobox width=80 height=17 var=amount list=10-USD;25-USD;50-USD;100-USD;></td>");
 				tb.append("</tr>");
 				tb.append("</table>");
 				tb.append("<br>");
 				tb.append("<br>");
 				tb.append("<font color=\"ddc16d\">Destination Number Phone:</font>");
 				tb.append("<table width=\"250\">");
 				tb.append("<tr>");
 				tb.append("<td><edit var=\"pin1\" width=140 height=12 type=number></td>");
 				tb.append("</table>");
 				tb.append("<br>");
 				tb.append("<br>");
 				...
 				tb.append("<br>");
 				tb.append("<br>");
 				tb.append("<button value=\"Donate!\" action=\"bypass -h .donateCmd $amount $pin1 $pin2 $pin3 $pin4 $message\" width=95 height=21 back=\"bigbutton_over\" fore=\"bigbutton\">");
 				tb.append("<br>");
