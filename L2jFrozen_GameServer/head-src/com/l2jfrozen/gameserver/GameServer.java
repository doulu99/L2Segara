...
public class GameServer
{
	...
	public static void main(final String[] args) throws Exception
	{
		...
		Util.printSection("Balance Loading...");
		LOGGER.info("                                                                ");
		LOGGER.info("      L2jFrozen balance you can reload balance from config.     ");
		LOGGER.info("		server is balance with skills/ressist/class damage       ");
		LOGGER.info("      if you want to change balance go to Config/functions      ");
		LOGGER.info("              and Change damage by fighter / mage               ");
		LOGGER.info("                                                                ");
		LOGGER.info("                                                                ");
		...
		Util.printSection("Auction Manager");
		LOGGER.info("            Auction House manager by Developer Luna            ");
		LOGGER.info("                Sell your Item from this npc                   ");
		LOGGER.info("                                                               ");
