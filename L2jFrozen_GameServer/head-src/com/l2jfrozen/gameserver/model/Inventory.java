		...
		public void notifyEquiped(final int slot, final L2ItemInstance item)
		{
			...
			if (armorSet.containItem(slot, item.getItemId()))
			{
				if (armorSet.containAll(player))
				{
					...
					if (armorSet.isEnchanted10(player))
				{
					 player.startAbnormalEffect(L2Character.ABNORMAL_EFFECT_IMPRISIONING_1);
		...
		public void notifyUnequiped(final int slot, final L2ItemInstance item)
		{
			...
			if (remove)
			{
				...
				if (removeSkillId1 != 0)
				{
					...
					player.stopAbnormalEffect(L2Character.ABNORMAL_EFFECT_IMPRISIONING_1);
