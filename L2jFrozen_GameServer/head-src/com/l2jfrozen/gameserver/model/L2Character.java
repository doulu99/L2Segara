...
public abstract class L2Character extends L2Object implements ISkillsHolder
{
	...
	public boolean isInsideZoneFuction(int zone)
	{
		return (_FactionZone & zone) != 0;
	}
	/**
	...
	public void setInsideZoneFaction(int zone, boolean state)
	{
		if(state)
		{
			_FactionZone |= zone;
		}
		else if(isInsideZoneFuction(zone))
		{
			_FactionZone ^= zone;
		}
	}
	 ...
	 * @return 
	 */
	public final String setTitle(String value)
	{
		if (value == null)
			value = "";
	...
	public static final int S_INVULNERABLE = 0x00000001;
